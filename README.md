...
Antes de utilizar el script, asegúrate de tener Python 2.7 instalado en tu sistema. Si estás utilizando Ubuntu o Debian, puedes ejecutar los siguientes comandos en tu terminal:

```
sudo apt update && sudo apt install python2.7 -y
```

Una vez que tienes Python 2.7 instalado, puedes proceder a instalar el script ejecutando:
...
En Windows, no es necesario instalar el script. En su lugar, en el directorio "src", ejecuta:
...
- Enviar todos los archivos de un directorio y sus subdirectorios a Chomikuj:
...
- Cargar un único archivo en Chomikuj:

```
chomik -u "/directorio1/directorio2/directorio3" "/home/nick/Documentos/archivo.txt"
```

- Iniciar sesión en Chomikuj (y subir archivos):
...
- Enviar varios archivos al mismo tiempo:

```
chomik -t 5 -r "/directorio1/directorio2/directorio3" "/home/nick/Documentos"
```

- Obtener información detallada sobre los errores:
